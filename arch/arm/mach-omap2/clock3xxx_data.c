...
//	CLK("davinci_emac",	"emac_clk",	&emac_ick,	CK_AM35XX), //STE
//	CLK("davinci_emac",	"phy_clk",	&emac_fck,	CK_AM35XX), //STE
	CLK("davinci_emac",	NULL,	&emac_ick,	CK_AM35XX), //STE
	CLK("davinci_mdio.0",	NULL,	&emac_fck,	CK_AM35XX), //STE
